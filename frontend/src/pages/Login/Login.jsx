...
import { doSignInWithEmailAndPassword, doSignInWithGoogle, doSignInWithGithub } from './../../components/Commons/auth';

const Login = () => {
    const [email, setEmail] = useState('');
    const [password, setPassword] = useState('');
    const [isSigningIn, setIsSigningIn] = useState(false);
    const [isGGSigningIn, setIsGGSigningIn] = useState(false);
    ...
    const onGoogleSignIn = (e) => {
        e.preventDefault();
        if (!isGGSigningIn) {
            setIsGGSigningIn(true);
            doSignInWithGoogle().catch((err) => {
                setIsGGSigningIn(false);
                console.log(err);
            });
        }
    };
            ...
            <main className="w-full h-screen flex self-center place-content-center place-items-center">
                <div className="w-96 text-gray-600 space-y-5 p-4 shadow-xl border rounded-xl">
                    ...
                    >
                        ...
                        {isGGSigningIn ? 'Signing In...' : 'Continue with Google'}
                    </button>
                    <button
